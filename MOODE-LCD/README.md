...
Copy this entire content, save it as `README.md`, and replace your current file. Then commit and push:

```bash
cd /Users/peter/Documents/PIXISREPO/PIXIS-PROJECTS/MOODE-LCD
git add README.md
git commit -m "Fix README: correct GitHub URL and add two-step install option"
git push
```
